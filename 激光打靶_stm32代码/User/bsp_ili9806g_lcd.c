...
void ILI9806G_Init ( void )
{
	...
	ILI9806G_GramScan ( 6 );//Set lcd show in mode 6
	LCD_SetFont(&Font16x32);
	LCD_SetColors(RED,BLACK);
	ILI9806G_Clear(0,0,LCD_X_LENGTH,LCD_Y_LENGTH);//Clear screen and set all to black.
}

void ILI9806_Test( void )
{
	//There being 26 lines
	LCD_SetTextColor(BLUE);
	ILI9806G_DispStringLine_EN(LINE(0),"LCD running");//Show a string at position line 0
	LCD_SetTextColor(GREEN);
	ILI9806G_DrawLine(0,10,100,300);//Draw line 
}
